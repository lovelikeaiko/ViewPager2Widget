...
public class RemoteViewsAdapter extends BaseAdapter implements Handler.Callback {
            ...
            adapter.mWorkerQueue.post(new Runnable() {
                ...
                public void run() {
                    if (adapter.mNotifyDataSetChangedAfterOnServiceConnected) {
                        ...
                        //modified by HP started, for data sync in ViewPager
                        //Log.i(TAG, "before RemoteViewsAdapter.onServiceConnected(), adapterCount=" + adapter.getCount()); 
                        adapter.onNotifyDataSetChanged();
                        //Log.i(TAG, "after RemoteViewsAdapter.onServiceConnected(), adapterCount=" + adapter.getCount());                

                        //modified by HP ended                        
                        
                    } else {
                        //Log.i(TAG, "before RemoteViewsAdapter.onServiceConnected(),"
                    ...
                    //we can not operate view in non-main thread
                    //if(adapter.mDataSetChangedListener!=null we
                    //    adapter.mDataSetChangedListener.onDataSetChanged();
                    //}
                    //so I use mMainQueue
                    adapter.mMainQueue.post(new Runnable() {
                        @Override
                        public void run() {
                            if(adapter.mDataSetChangedListener!=null){
                                adapter.mDataSetChangedListener.onDataSetChanged();
                            }                                 
                        }
                    });    
    ...
    private static class RemoteViewsMetaData {
        ...
        private RemoteViewsFrameLayout createLoadingView(int position, View convertView,
            ...
            //merged by HP started
            //Log.i(TAG, "createLoadingView, handler=" + handler + ", position=" + position
            //    + ", convertView=" + convertView + ", parent=" + parent
            //    + ", mUserLoadingView=" + mUserLoadingView );
    ...
    private static class FixedSizeRemoteViewsCache {
        ...
        public void queueRequestedPositionToLoad(int position) {
            ...
            //merged by HP started
            //Log.i(TAG, "queueRequestedPositionToLoad, position=" + position
            //    + "mLoadIndices.size=" + mLoadIndices.size() + "mRequestedIndices.size=" + mRequestedIndices.size());
            //merged by HP ended              
        }
        public boolean queuePositionsToBePreloadedFromRequestedPosition(int position) {
            ...
            synchronized (mLoadIndices) {
                ...
                //merged by HP started
                //Log.i(TAG, "queuePositionsToBePreloadedFromRequestedPosition, mLoadIndices.size="
                //    + mLoadIndices.size());
                //merged by HP ended                 
        ...
        mWorkerQueue.post(new Runnable() {
            ...
            public void run() {
                if (mServiceConnection.isConnected()) {
                    ...
                    //merged by HP started
                    //Log.i(TAG, "loadNextIndexInBackground, position=" + position);
                    //merged by HP ended  
    ...
    private void updateTemporaryMetaData() {
        ...
        try {
            ...
            //merged by HP started
            //Log.i(TAG, "updateTemporaryMetaData, count=" + factory.getCount()
            //    + ", loadingView=" + loadingView + ", firstView=" + firstView );
            //merged by HP ended
    ...
    private void updateRemoteViews(final int position, boolean notifyWhenLoaded) {
        ...
        //merged by HP started
        //Log.i(TAG, "updateRemoteViews, position" + position);
        //merged by HP ended
        ...
        synchronized (mCache) {
            if (viewTypeInRange) {
                ...
                //merged by HP started
                //Log.i(TAG, "updateRemoteViews, mVisibleWindowLowerBound=" + mVisibleWindowLowerBound
                //    + ", mVisibleWindowUpperBound="  + mVisibleWindowUpperBound
                //    + ", visibleWindow.size="  + visibleWindow.size());
                //merged by HP ended
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        synchronized (mCache) {
            ...
            if (!isInCache && !isConnected) {
                ...
                //merged by HP started
                //Log.i(TAG, "getView, before queuePositionsToBePreloadedFromRequestedPosition,"
                //    + ", position=" + position
                //    + ", convertView=" + convertView + ", parent=" + parent );
                //merged by HP ended            
            ...
            //merged by HP started
            //Log.i(TAG, "getView, isInCache=" + isInCache + ", position=" + position
            //    + ", convertView=" + convertView + ", parent=" + parent );
            //merged by HP ended               
    ...
    public void notifyDataSetChanged() {
        ...
        //Log.i(TAG, "in RemoteViewsAdapter.onNotifyDataSetChanged()"); 
        ...
        //Log.i(TAG, "before RemoteViewsAdapter.onNotifyDataSetChanged(), mWorkerQueue.post(new Runnable()"); 
        mWorkerQueue.post(new Runnable() {
            @Override
            public void run() {
                //modified by HP started, for data sync in ViewPager
                //Log.i(TAG, "before RemoteViewsAdapter.onNotifyDataSetChanged(), adapterCount=" + getCount()); 
                onNotifyDataSetChanged();
                //Log.i(TAG, "after RemoteViewsAdapter.onNotifyDataSetChanged(), adapterCount=" + getCount());  
